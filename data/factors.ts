...
export const factorRows: Factor[][] = [
  [
    ...
    { id: "parents_age", questionId: "family_parent_care", label: "Your parents getting older", weight: 1 },
    { id: "fresh_grad", questionId: "career_fresh_grad_hiring", label: "Fresh graduate hiring", weight: 2 },
    { id: "partner", questionId: "family_partner_plans", label: "Where your partner wants to be", weight: 3 },
    ...
    { id: "green_card", questionId: "immigration_green_card_path", label: "The green card wait", weight: 2 },
  ...
  [
    { id: "savings", questionId: "salary_savings_outlook", label: "Pay growth", weight: 2 },
    { id: "opt", questionId: "immigration_lottery_runway", label: "OPT running out", weight: 3 },
    ...
    { id: "health_insurance", questionId: "lifestyle_healthcare", label: "Health insurance", weight: 1 },
    { id: "job_gap", questionId: "salary_job_gap_runway", label: "A gap between jobs", weight: 2 },
  ...
  [
    ...
    { id: "kids_school", questionId: "long_term_children_schooling", label: "Where the kids go to school", weight: 2 },
    { id: "retire", questionId: "long_term_retirement_place", label: "Where you grow old", weight: 1 }
  ]
];
